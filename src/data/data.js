const data = [
    ...
    { name: '顶层设计', scenario: '数字经济基础设施——数据中心能源系统的顶层设计', meaning: '从全局的角度统筹计划', origin: '空', rankingCommunication: 2, rankingUnderstanding: 3, rankingLikeable: 1, hasSource: false },
    { name: '底层逻辑', scenario: '一个人职场想要混的好，这几条底层逻辑要上心', meaning: '问题的根本原因', origin: '空', rankingCommunication: 2, rankingUnderstanding: 3, rankingLikeable: 1, hasSource: false },
